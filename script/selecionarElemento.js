...
export function substituirElemento(dadosDoElemento, corElemento) {
    ...
    const pontoDeFusao = document.querySelectorAll('.pontoDeFusao').forEach(elemento => elemento.innerHTML = dadosDoElemento.pontoDeFusao)
    const pontoDeEbulicao = document.querySelectorAll('.pontoDeEbulicao').forEach(elemento => elemento.innerHTML = dadosDoElemento.pontoDeEbulicao)
    const densidade = document.querySelectorAll('.densidade').forEach(elemento => elemento.innerHTML = dadosDoElemento.densidade)
