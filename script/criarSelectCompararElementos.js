...
function criarSelectCompararElemento() {
    ...
    select1.addEventListener('change', (e) => {
        ...
        document.querySelector('.propriedades-fisicas-densidade-1').innerHTML = dadosDoElementoSelecionado.densidade ? `${parseFloat(dadosDoElementoSelecionado.densidade).toFixed(3)}g/cm3`: 'Não disponível'
        ...
        document.querySelector('.propriedades-fisicas-entalpia-de-fusao-1').innerHTML = dadosDoElementoSelecionado.etalpiaDeFusao ? `${parseFloat(dadosDoElementoSelecionado.etalpiaDeFusao).toFixed(1)}kJ/mol`: 'Não disponível'
        document.querySelector('.propriedades-fisicas-entalpia-de-vaporizacao-1').innerHTML = dadosDoElementoSelecionado.etalpiaDeVaporizacao ? `${parseFloat(dadosDoElementoSelecionado.etalpiaDeVaporizacao).toFixed(1)}kJ/mol`: 'Não disponível'
        document.querySelector('.propriedades-fisicas-calor-especifico-1').innerHTML = dadosDoElementoSelecionado.calorEspecifico ? `${parseFloat(dadosDoElementoSelecionado.calorEspecifico).toFixed(3)}J/g·K`: 'Não disponível'
        ...
        document.querySelector('.propriedades-atomicas-volume-atomico-1').innerHTML = dadosDoElementoSelecionado.volumeAtomico ? `${parseFloat(dadosDoElementoSelecionado.volumeAtomico).toFixed(2)}cm³/mol`: 'Não disponível'
        document.querySelector('.propriedades-atomicas-condutividade-termica-1').innerHTML = dadosDoElementoSelecionado.volumeAtomico ? `${parseFloat(dadosDoElementoSelecionado.condutividadeTermica).toFixed(3)}W/cm·K`: 'Não disponível'
    ...
    select2.addEventListener('change', (e) => {
        ...
        document.querySelector('.propriedades-fisicas-densidade-2').innerHTML = dadosDoElementoSelecionado.densidade ? `${parseFloat(dadosDoElementoSelecionado.densidade).toFixed(3)}g/cm3`: 'Não disponível'
        ...
        document.querySelector('.propriedades-fisicas-entalpia-de-fusao-2').innerHTML = dadosDoElementoSelecionado.etalpiaDeFusao ? `${parseFloat(dadosDoElementoSelecionado.etalpiaDeFusao).toFixed(1)}kJ/mol`: 'Não disponível'
        document.querySelector('.propriedades-fisicas-entalpia-de-vaporizacao-2').innerHTML = dadosDoElementoSelecionado.etalpiaDeVaporizacao ? `${parseFloat(dadosDoElementoSelecionado.etalpiaDeVaporizacao).toFixed(1)}kJ/mol`: 'Não disponível'
        document.querySelector('.propriedades-fisicas-calor-especifico-2').innerHTML = dadosDoElementoSelecionado.calorEspecifico ? `${parseFloat(dadosDoElementoSelecionado.calorEspecifico).toFixed(3)}J/g·K`: 'Não disponível'
        ...
        document.querySelector('.propriedades-atomicas-volume-atomico-2').innerHTML = dadosDoElementoSelecionado.volumeAtomico ? `${parseFloat(dadosDoElementoSelecionado.volumeAtomico).toFixed(2)}cm³/mol`: 'Não disponível'
        document.querySelector('.propriedades-atomicas-condutividade-termica-2').innerHTML = dadosDoElementoSelecionado.volumeAtomico ? `${parseFloat(dadosDoElementoSelecionado.condutividadeTermica).toFixed(3)}W/cm·K`: 'Não disponível'
